...
echo "port=3311" | sudo tee -a /etc/mysql/my.cnf
...
MYSQL_PWD=root mysql -u root -e "CREATE USER 'bootcamp'@'%' IDENTIFIED BY 'letMeIn'; GRANT ALL PRIVILEGES ON *.* TO 'bootcamp'@'%' WITH GRANT OPTION; FLUSH PRIVILEGES;"
